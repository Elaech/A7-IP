...
import {createPost, getPostByPostId,getPMessageByPMessageId} from './postController'
...
export {getAllUsers, login, register, createPost, registerRole, getGroupeList,getProfessorList,tutorGroupeList,getPostByPostId,getPMessageByPMessageId}
