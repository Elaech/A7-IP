...
import {createPost, getPostByPostId} from './postController'
...
export {getAllUsers, login, register, createPost, registerRole, getGroupeList,getProfessorList,tutorGroupeList,getPostByPostId}
