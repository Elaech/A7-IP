...
import {createPost, getPostByPostId,getPostList} from './postController'
...
export {getAllUsers, login, register, createPost, registerRole, getGroupeList,getProfessorList,tutorGroupeList,getPostByPostId,getPostList}
